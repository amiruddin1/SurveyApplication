...
@Database(entities = [VillageEntity::class, HeadOftheFamilyEntity::class, FamilyMemberEntity::class, HealthCareEntity::class, DiseaseDetailsEntity::class], version = 2)
